...
Stolen from a secret weapons factory on [Diado](https://swse.fandom.com/wiki/Diado) by Jedi Master Saesee Tiin, the CIS-Advanced Starfighter is a prototype that never sees actual battlefield use except in a few trials. However, many of the systemic innovations are borrowed by Republic engineers for inclusion on Republic Starships such as the [[04_Equipaggiamento/04.04_Astronavi/eta-2-actis-interceptor.md|Eta-2 *Actis* Interceptor]] developed by Kuat Systems Engineering specifically for Jedi fighter pilots.
