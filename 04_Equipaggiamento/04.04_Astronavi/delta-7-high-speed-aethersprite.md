...
Although the [[04_Equipaggiamento/04.04_Astronavi/delta-7-aethersprite-interceptor.md|Delta-7 *Aethersprite* Interceptor]] is one of the fastest ships to be used by the Republic during the Clone Wars, certain missions undertaken by [The Jedi](https://swse.fandom.com/wiki/The_Jedi) require an even faster model to help avoid any possible entanglements with Separatist forces.
